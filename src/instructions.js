...
export function createInstructionPage({id, type, src, description}) {
    ...
    if (id === 1) {
      ...
      <p style="font-size: large">
        ...
        objects based on provided statements. There are 3 phases in this study and your goal is to complete as many trials as accurately as possible in each phase.
